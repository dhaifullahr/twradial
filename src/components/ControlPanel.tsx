      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-2">
            <button id="randomizeBtn" className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 text-sm" title="Randomize All">
            ...
            <button id="resetBtn" className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 text-sm" title="Reset All">
        ...
        <div className="mb-6">
          ...
          <button id="addColor" className="mt-4 w-full flex items-center justify-center space-x-2 p-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 border border-blue-500/30 rounded-xl transition-all duration-200 text-sm font-medium text-blue-300">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-700 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button id="copyBtn" className="flex items-center space-x-1 px-3 py-1.5 bg-green-500/20 hover:bg-green-500/30 text-green-300 rounded-lg transition-all duration-200 text-xs">
